...
(function (f) {
    ...
    h(f, "modules/exporting.src.js", [f["parts/Globals.js"], f["mixins/navigation.js"]], function (c, f) {
        var h = c.defaultOptions, n = c.doc, A = c.Chart, v = c.addEvent, C = c.removeEvent, D = c.fireEvent,
            r = c.createElement, E = c.discardElement, w = c.css, p = c.merge, t = c.pick, F = c.objectEach,
        ...
        c.post = function (b, a, c) {
            ...
            }, c), {display: "none"}, n.body);
            F(a, function (a, b) {
                r("input", {type: "hidden", name: b, value: a}, null, d)
            });
            d.submit();
            E(d)
        };
        y(A.prototype, {
            sanitizeSVG: function (b, a) {
                ...
                return this.getSVG(p({chart: {borderRadius: 0}}, c.chartOptions, a, {
                    exporting: {
                ...
                var a = this, c = [], d = n.body, f = d.childNodes, m = a.options.exporting.printMaxWidth, k, e;
                if (!a.isPrinting) {
                    a.isPrinting =
                        !0;
                ...
                var e = this, x = e.options.navigation,
                    l = e.chartWidth, q = e.chartHeight, h = "cache-" + b, g = e[h], B = Math.max(f, m), p;
                g || (e.exportContextMenu = e[h] = g = r("div", {className: b}, {
                    position: "absolute",
                    zIndex: 1E3,
                    padding: B + "px",
                    pointerEvents: "auto"
                }, e.fixedDiv || e.container), p = r("div", {className: "highcharts-menu"}, null, g), e.styledMode || w(p, y({
                    ...
                    if (c.isObject(a, !0)) {
                        ...
                        }, w(b, y({cursor: "pointer"}, x.menuItemStyle))));
                ...
                var a = this, c = a.renderer, d = p(a.options.navigation.buttonOptions, b), f = d.onclick,
                    m = d.menuItems, k, e, h = d.symbolSize || 12;
                a.btnCount || (a.btnCount = 0);
                a.exportDivElements || (a.exportDivElements = [], a.exportSVGElements = []);
                if (!1 !== d.enabled) {
                    var l = d.theme, q = l.states, n = q && q.hover, q = q && q.select, g;
                    ...
                    e = c.button(d.text, 0, 0, g, l, n, q).addClass(b.className).attr({title: t(a.options.lang[d._titleKey || d.titleKey], "")});
                    ...
                    e.add(a.exportingGroup).align(y(d, {width: e.width, x: t(d.x, a.buttonOffset)}), !0, "spacingBox");
        ...
        A.prototype.inlineStyles = function () {
            ...
            var c = this.renderer, d = c.inlineToAttributes, f = c.inlineBlacklist, h = c.inlineWhitelist,
                ...
                e = {}, x, l, c = n.createElement("iframe");
            w(c, {width: "1px", height: "1px", visibility: "hidden"});
