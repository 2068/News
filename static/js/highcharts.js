...
(function (N, K) {
    ...
    K(F, "parts/Globals.js", [], function () {
        var a = "undefined" === typeof N ? "undefined" !== typeof window ? window : {} : N, C = a.document,
            ...
            k = /(edge|msie|trident)/i.test(I) && !a.opera, d = -1 !== I.indexOf("Firefox"),
            q = -1 !== I.indexOf("Chrome"), t = d && 4 > parseInt(I.split("Firefox/")[1], 10);
        return {
            product: "Highcharts",
            version: "7.1.0",
    ...
    K(F, "parts/SvgRenderer.js", [F["parts/Globals.js"]], function (a) {
        var C, I, H = a.addEvent, k = a.animate, d = a.attr, q = a.charts, t = a.color, u = a.css, v = a.createElement,
            ...
            n = a.merge, E = a.noop, z = a.objectEach, A = a.pick, D = a.pInt, h = a.removeEvent, y = a.splat,
            M = a.stop, R = a.svg, L = a.SVG_NS, S = a.symbolSizes,
            P = a.win;
        ...
        l(C.prototype, {
            ...
            destroy: function () {
                var a = this, h = a.element || {}, c = a.renderer,
                    f = c.isSVG && "SPAN" === h.nodeName && a.parentGroup, y = h.ownerSVGElement, e = a.clipPath;
        ...
        l(I.prototype, {
            ...
            buildText: function (a) {
                var h = a.element, c = this, f = c.forExport, b = A(a.textStr, "").toString(),
                    x = -1 !== b.indexOf("\x3c"), y = h.childNodes, e, n = d(h, "x"), l = a.styles, g = a.textWidth,
                    w = l && l.lineHeight, E = l && l.textOutline, r = l && "ellipsis" === l.textOverflow, p =
                    l && "nowrap" === l.whiteSpace, B = l && l.fontSize, M, S, G = y.length,
                    l = g && !a.added && this.box, J = function (a) {
                        var b;
            ...
            symbol: function (a, h, c, b, f, y) {
                ...
                w ? (n = this.path(E), e.styledMode || n.attr("fill", "none"), l(n, {
                    ...
                    x: h,
                    y: c
                }), n.isImg = !0, p(n.imgwidth) && p(n.imgheight) ? z() : (n.attr({width: 0, height: 0}), v("img", {
                    onload: function () {
            ...
            label: function (c, b, f, y, e, g, L, w, m) {
                var x = this, E = x.styledMode, r = x.g("button" !== m && "label"),
                    z = r.text = x.text("", 0, 0, L).attr({zIndex: 1}), d, D, R = 0, A = 3, M = 0, B, S, G, k, J,
                    P = {}, v, q, t = /^url\((.*?)\)$/.test(y), u = E || t, Q = function () {
    ...
    K(F, "parts/Html.js", [F["parts/Globals.js"]], function (a) {
        ...
        d(g.prototype, {
            htmlCss: function (a) {
                ...
                if (this.added) {
                    var a = this.renderer, b = this.element, f = this.translateX || 0, c = this.translateY || 0,
                        e = this.x || 0, g = this.y || 0, m = this.textAlign || "left",
                        d = {left: 0, center: .5, right: 1}[m], B = this.styles, n = B && B.whiteSpace;
    ...
    K(F, "parts/Time.js", [F["parts/Globals.js"]], function (a) {
        ...
        a.Time.prototype = {
            defaultOptions: {}, update: function (a) {
                ...
                var p = this, g = new this.Date(k), e = this.get("Hours", g), m = this.get("Day", g),
                    l = this.get("Date", g), b = this.get("Month", g), f = this.get("FullYear", g),
                    c = a.defaultOptions.lang, w = c.weekdays, r = c.shortWeekdays, J = a.pad, g = a.extend({
    ...
    K(F, "parts/Tick.js", [F["parts/Globals.js"]], function (a) {
        var C = a.correctFloat, I = a.defined, H = a.destroyObjectProperties, k = a.fireEvent, d = a.isNumber,
        ...
        a.Tick.prototype = {
            addLabel: function () {
                ...
                var d = this.axis, g = d.options.labels, e = a.x, m = d.chart.chartWidth, l = d.chart.spacing,
                    ...
                    l = t(d.labelRight, Math.max(d.isRadial ? 0 : d.pos + d.len, m - l[1])), f = this.label,
                    c = this.rotation,
                ...
                return d
                                           ...
                                           m, l, b, f) {
                var c = this.axis, w = c.transA, r = c.reversed, p = c.staggerLines, G = c.tickRotCorr || {x: 0, y: 0},
                    B = m.y, n = e || c.reserveSpaceDefault ? 0 : -c.labelOffset * ("center" === c.labelAlign ? .5 : 1),
                    E = {};
    ...
    K(F, "parts/Axis.js", [F["parts/Globals.js"]], function (a) {
        var C = a.addEvent, I = a.animObject, H = a.arrayMax, k = a.arrayMin, d = a.color, q = a.correctFloat,
            ...
            e = a.fireEvent, m = a.format, l = a.getMagnitude, b = a.isArray, f = a.isNumber, c = a.isString,
            w = a.merge, r = a.normalizeTickInterval, J = a.objectEach, G = a.pick, B = a.removeEvent,
            n = a.seriesTypes, E = a.splat, z = a.syncTimeout, A = a.Tick, D = function () {
                this.init.apply(this, arguments)
            };
        a.extend(D.prototype, {
            ...
            defaultLabelFormatter: function () {
                var h = this.axis, b = this.value, c = h.chart.time, f = h.categories, e = this.dateTimeLabelFormat,
                    n = t.lang, l = n.numericSymbols, n = n.numericSymbolMagnitude || 1E3, g = l && l.length, d,
            ...
            getPlotLinePath: function (a, b, c, n,
                                       l) {
                var h = this, y = h.chart, g = h.left, d = h.top, r, m, w, z,
                    E = c && y.oldChartHeight || y.chartHeight, L = c && y.oldChartWidth || y.chartWidth, p,
                    D = h.transB, A, B = function (a, h, b) {
            ...
            getMinorTickPositions: function () {
                var a =
                    ...
                    n = a.pointRangePadding || 0, l = a.min - n, n = a.max + n, g = n - l;
            ...
            setTickInterval: function (h) {
                var b = this,
                    ...
                    z = n.maxPadding, E = n.minPadding, p, D = n.tickInterval, A = n.tickPixelInterval,
                    B = b.categories, k = f(b.threshold) ? b.threshold : null, J = b.softThreshold, v, t, C;
            ...
            adjustTickAmount: function () {
                var a = this.options, b = this.tickInterval, c = this.tickPositions, f = this.tickAmount,
                    e = this.finalTickAmt, n = c && c.length, l = G(this.threshold, this.softThreshold ? 0 : null), g;
                if (this.hasData()) {
                    if (n < f) {
            ...
            getThreshold: function (a) {
                var b = this.isLog, h = b ? this.lin2log(this.min) : this.min,
            ...
            getLinePath: function (a) {
                var b =
                        this.chart, c = this.opposite, h = this.offset, f = this.horiz,
            ...
            render: function () {
                var b = this, c = b.chart, n = b.options,
                    ...
                    E = b.alternateBands, p = n.stackLabels, D = n.alternateGridColor, k = b.tickmarkOffset,
                    B = b.axisLine, G = b.showAxis, q = I(c.renderer.globalAnimation), v, t;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                ...
                var d = this, p = d.axis, g = p.horiz, e = d.options, m = e.label, l = d.label, b = e.to, f = e.from,
                    c = e.value, w = k(f) && k(b), r = k(c), q = d.svgElem, G = !q, B = [], n = e.color,
                    E = u(e.zIndex, 0), z = e.events,
    ...
    K(F, "parts/Tooltip.js", [F["parts/Globals.js"]], function (a) {
        var C = a.doc, I = a.extend, H = a.format, k = a.isNumber, d = a.merge, q = a.pick, t = a.splat,
        ...
        a.Tooltip.prototype = {
            init: function (a, d) {
                ...
                var e = this, m = [], l = this.chart, b = l.renderer, f = !0, c = this.options, w = 0, r,
                    k = this.getLabel(), p = l.plotTop;
                a.isString(d) && (d = [!1, d]);
                d.slice(0, g.length + 1).forEach(function (a, n) {
                    if (!1 !== a && "" !== a) {
                        n = g[n - 1] || {isHeader: !0, plotX: g[0].plotX, plotY: l.plotHeight};
                        var d = n.series || e, z = d.tt, A = n.series || {},
        ...
        a.Pointer.prototype = {
            ...
            findNearestKDPoint: function (a, b, e) {
                ...
                var f = this.chart, e = f.tooltip && f.tooltip.options.enabled ? f.tooltip : void 0,
                    d = e ? e.shared : !1, l = c || f.hoverPoint, g = l && l.series || f.hoverSeries,
            ...
            drag: function (a) {
                var b = this.chart, f = b.options.chart, e = a.chartX, d = a.chartY, l = this.zoomHor,
                    g = this.zoomVert, n = b.plotLeft, m = b.plotTop, z = b.plotWidth, A = b.plotHeight, D,
                    h = this.selectionMarker, p = this.mouseDownX, q = this.mouseDownY,
                ...
                if (this.selectionMarker) {
                    var l = {originalEvent: a, xAxis: [], yAxis: []}, g = this.selectionMarker,
                        m = g.attr ? g.attr("x") : g.x, n = g.attr ?
                        g.attr("y") : g.y, E = g.attr ? g.attr("width") : g.width,
                        z = g.attr ? g.attr("height") : g.height, k;
                    if (this.hasDragged || e) f.axes.forEach(function (c) {
                        if (c.zoomEnabled && q(c.min) && (e || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                            var f = c.horiz, d = "touchend" === a.type ? c.minPixelPadding : 0,
                                g = c.toValue((f ? m : n) + d), f = c.toValue((f ? m + E : n + z) - d);
    ...
    K(F, "parts/TouchPointer.js", [F["parts/Globals.js"]], function (a) {
        ...
        I(a.Pointer.prototype, {
            pinchTranslate: function (a,
                ...
                var d = this, t = d.chart, u = d.pinchDown, v = a.touches, p = v.length, g = d.lastValidTouch,
                    e = d.hasZoom, m = d.selectionMarker, l = {},
                ...
                "touchstart" === a.type ? ([].forEach.call(v, function (a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b = t.bounds[a.horiz ? "h" : "v"], c = a.minPixelPadding,
                            f = a.toPixels(k(a.options.min, a.dataMin)), e = a.toPixels(k(a.options.max, a.dataMax)),
                            d = Math.max(f, e);
    ...
    K(F, "parts/Legend.js", [F["parts/Globals.js"]], function (a) {
        ...
        a.Legend.prototype = {
            init: function (a, b) {
                ...
                if (!this.chart.styledMode) {
                    var e = this.options, c = a.legendItem, l = a.legendLine, g = a.legendSymbol,
                        m = this.itemHiddenStyle.color, e = b ? e.itemStyle.color : m, k = b ? a.color || m : m,
                ...
                var b = this.options, e = b.symbolPadding, b = !b.rtl, c = a._legendItemPos, d = c[0], c = c[1],
                    l = a.checkbox;
                ...
                var b = this.chart, e = b.renderer, c = this.options, d = this.symbolWidth, g = c.symbolPadding,
                    l = this.itemStyle, m = this.itemHiddenStyle,
                    k = "horizontal" === c.layout ? v(c.itemDistance, 20) : 0, n = !c.rtl, E = a.legendItem,
                    z = !a.series, A = !z && a.series.drawLegendSymbol ? a.series : a, D = A.options,
                    D = this.createCheckboxForItem && D && D.showCheckbox, k = d + g + k + (D ? 20 : 0), h = c.useHTML,
            ...
            getAllItems: function () {
                ...
                var e = this.chart, b = e.renderer, f = this.group, c, m, r, k = this.box, p = this.options,
                    B = this.padding;
                this.itemX = B;
                this.itemY =
                    this.initialItemY;
                ...
                var b = this, e = this.chart, c = e.renderer, d = this.options, g = d.y, l = this.padding,
                    g = e.spacingBox.height + ("top" === d.verticalAlign ? -g : g) - l, m = d.maxHeight, k,
                    n = this.clipRect, E = d.navigation, z = v(E.animation, !0), A = E.arrowSize || 12, D = this.nav,
                    h = this.pages, p, q = this.allItems, t = function (a) {
        ...
        a.LegendSymbolMixin = {
            ...
            drawLineMarker: function (a) {
                var b = this.options, e = b.marker, c = a.symbolWidth, d = a.symbolHeight, g = d / 2,
                    m = this.chart.renderer, l = this.legendGroup;
        ...
        m(R.prototype, {
            callbacks: [], getArgs: function () {
                ...
                var e = this.axes, h = this.series, d = this.pointer, f = this.legend, n = this.userOptions.legend,
                    g = this.isDirtyLegend, l, z, k = this.hasCartesianSeries, E = this.isDirtyBox, r,
                    D = this.renderer, A = D.isHidden(), p = [];
                ...
                var c = this.inverted, e = this.renderer, h = this.chartWidth, d = this.chartHeight,
                    f = this.options.chart, n = this.spacing, g = this.clipOffset, l, m, z, k;
    ...
    K(F, "parts/Point.js", [F["parts/Globals.js"]], function (a) {
        ...
        a.Point.prototype = {
            init: function (a, d, g) {
                ...
                var d = {}, g = this.series, b = g.options.keys, f = b || g.pointArrayMap || ["y"], c = f.length, k = 0,
                    r = 0;
    ...
    K(F, "parts/Series.js", [F["parts/Globals.js"]], function (a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            setData: function (b, d, f, g) {
                var n = this, h = n.points, k = h && h.length || 0, r, E = n.options, p = n.chart, z = null,
                    A = n.xAxis, w = E.turboThreshold, B = this.xData, q = this.yData,
                    t = (r = n.pointArrayMap) && r.length, u = E.keys, G = 0, v = 1, J;
                b = b || [];
                r = b.length;
                d = c(d, !0);
            ...
            translate: function () {
                ...
                var a = this.options, b = a.stacking, f = this.xAxis, l = f.categories, k = this.yAxis, h = this.points,
                    r = h.length, p = !!this.modifyValue, w, B = this.pointPlacementToXValue(), q = m(B),
                    t = a.threshold, x = a.startFromThreshold ? t : 0, G, v, J, C, H = this.zoneAxis || "y",
                    I = Number.MAX_VALUE;
                for (w = 0; w < r; w++) {
                    var F = h[w], K = F.x;
                    v = F.y;
                    var V = F.low, N = b && k.stacks[(this.negStacks && v < (x ? 0 : t) ? "-" : "") + this.stackKey], W,
                        Y;
            ...
            setClip: function (a) {
                var b = this.chart, c = this.options, e = b.renderer, d = b.inverted, h = this.clipBox,
                    f = h || b.clipBox,
            ...
            applyZones: function () {
                var a = this, b = this.chart, e = b.renderer, d = this.zones, f, h, g = this.clips || [], l,
                    m = this.graph, k = this.area, r = Math.max(b.chartWidth, b.chartHeight),
                    p = this[(this.zoneAxis || "y") + "Axis"], w, B, q = b.inverted, t, u, G, v, J = !1;
            ...
            render: function () {
                var a = this, b = a.chart, c, e = a.options,
                    ...
                    h = a.visible ? "inherit" : "hidden", f = e.zIndex, l = a.hasRendered, m = b.seriesGroup,
                    k = b.inverted;
                g(this, "render");
            ...
            redraw: function () {
                var a = this.chart, b = this.isDirty || this.isDirtyData, e = this.group, d = this.xAxis,
                    f = this.yAxis;
                e && (a.inverted && e.attr({
                    width: a.plotWidth,
                    height: a.plotHeight
    ...
    K(F, "parts/Stacking.js", [F["parts/Globals.js"]], function (a) {
        ...
        a.StackItem.prototype = {
            destroy: function () {
                ...
                var d = this.axis.chart, e = this.options, m = e.format,
    ...
    K(F, "parts/Dynamics.js", [F["parts/Globals.js"]], function (a) {
        ...
        v(w.prototype, {
            addPoint: function (a, b, c, e, d) {
                var g = this.options, h = this.data, l = this.chart, n = this.xAxis, n = n && n.hasNames && n.names,
                    m = g.data, k, r, w = this.xData, q, t;
                b = f(b, !0);
                k = {series: this};
        ...
        v("column", "line", {
            ...
            translate: function () {
                ...
                a.points.forEach(function (d) {
                    var g = t(d.yBottom, c), l = 999 + Math.abs(g), n = q,
                        l = Math.min(Math.max(-l, d.plotY), b.len + l), m = d.plotX + B, h = G, r = Math.min(l,
    ...
    K(F, "parts/PieSeries.js", [F["parts/Globals.js"]], function (a) {
        var C = a.addEvent, F = a.CenteredSeriesMixin, H = a.defined, k = F.getStartAndEndRadians, d = a.merge,
            q = a.noop, t = a.pick, u = a.Point, v = a.Series, p = a.seriesType, g = a.setAnimation;
        p("pie", "line", {
            center: [null,
                null],
            clip: !1,
            ...
            translate: function (a) {
                ...
                var e = 0, d = this.options, b = d.slicedOffset, f = b + (d.borderWidth || 0), c, g,
                    r = k(d.startAngle, d.endAngle), p = this.startAngleRad = r.start,
                    r = (this.endAngleRad = r.end) - p, q = this.points, u, n, v = d.dataLabels.distance,
                    d = d.ignoreHiddenPoint, z, A = q.length, D;
            ...
            init: function () {
                ...
                var a = this.labelPosition, d = this.series.options.dataLabels, g = d.connectorShape,
    ...
    K(F, "parts/DataLabels.js", [F["parts/Globals.js"]], function (a) {
        var C = a.addEvent, F = a.arrayMax, H = a.defined, k = a.extend, d = a.format, q = a.merge, t = a.noop,
            u = a.pick, v = a.relativeLength, p = a.Series, g = a.seriesTypes, e = a.stableSort, m = a.isArray,
            l = a.splat;
        ...
        g.pie && (g.pie.prototype.dataLabelPositioners = {
            ...
            var b = this, d = b.data, c, e = b.chart, g = b.options.dataLabels, k = g.connectorPadding, l,
                m = e.plotWidth, n = e.plotHeight, t = e.plotLeft, v = Math.round(e.chartWidth / 3), A, D = b.center,
                h = D[2] / 2, y = D[1], C, I, L, K, P = [[], []], x, Q, N, T, O = [0, 0, 0, 0],
        ...
        w = a.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                var a = this, b = a.options, d = b.trackByArea, e = [].concat(d ? a.areaPath : a.graphPath),
                    f = e.length, g = a.chart, k = g.pointer, l = g.renderer, m = g.options.tooltip.snap, h = a.tracker,
                    p, q = function () {
                ...
                u(this, "pan", {originalEvent: a}, function () {
                    ...
                    ("xy" === b ? [1, 0] : [1]).forEach(function (b) {
                        ...
                        var d = b.horiz, f = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", g = c[d],
                            ...
                            n = b.toValue(g - f, !0) + h * k, k = b.toValue(g + b.len - f, !0) - h * k, m = k < n,
                            g = m ? k : n, n = m ? n : k,
        ...
        t(l.prototype, {
            select: function (a, b) {
                ...
                var c = Math.floor(this.plotX), d = this.plotY, e = this.series, f = this.state,
                    ...
                    r = e.stateMarkerGraphic, v = this.marker || {}, w = e.chart, C = e.halo, F, x, H,
                    I = k && e.markerAttribs;
                a = a || "";
        ...
        t(b.prototype, {
            ...
            setState: function (a, b) {
                var c = this, d = c.options, e = c.graph, f = d.inactiveOtherPoints, g = d.states, k = d.lineWidth,
                    l = d.opacity,
                    h = m(g[a || "normal"] && g[a || "normal"].animation, c.chart.options.chart.animation), d = 0;
                a = a || "";
